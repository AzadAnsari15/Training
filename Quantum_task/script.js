        ...
        accordionItems.forEach((item) => {
          ...
          header.addEventListener("click", function () {
            ...
            if (item.classList.contains("active")) {
              ...
              arrow.innerHTML = "expand_less"; // Show the "expand_less" (upward arrow) icon
            } else {
              content.style.display = "none";
              arrow.innerHTML = "expand_more"; // Show the "expand_more" (downward arrow) icon
            }
          });
        });
      });
      ...
      document
        ...
        .addEventListener("click", function () {
          var navItems1 = document.querySelector(".menu-items1");

          // Toggle the menuOpen variable
          menuOpen = !menuOpen;

          if (menuOpen) {
            // Change the src attribute to the "unhamburger-menu.svg" when menu is open
            document.getElementById("menu-button").src =
              "icons/unhamburger-menu.svg";
            navItems1.style.display = "flex";
          } else {
            // Change the src attribute back to the "hamburger-menu.svg" when menu is closed
            document.getElementById("menu-button").src =
      ...
      function toggleAnnouncementNotifications() {
        const announcementNotifications = document.querySelector(
      ...
      document.addEventListener("DOMContentLoaded", function () {
        const announcementContents = document.querySelectorAll(
        ...
        function updateNotificationCount() {
          ...
          notiCount.textContent = unreadCount > 0 ? unreadCount : "";
      ...
      function toggleAlarmNotifications() {
        const alarmNotifications = document.querySelector(
          ".alarm-notification"
        );
