document.addEventListener("DOMContentLoaded", function () {
  const accordionItems = document.querySelectorAll<HTMLElement>(
    ".menu-items1 .accordion-item"
  );
  ...
  accordionItems.forEach((item) => {
    ...
    const arrow = item.querySelector<HTMLElement>(
...
document.getElementById("menu-button")?.addEventListener("click", function () {
  const navItems1 = document.querySelector<HTMLElement>(".menu-items1");
...
interface Course {
  ...
  image: string;
  favourite: string;
  expired: "expired" | "unexpired"; // Limited to these two possible values
  course_p?: string;
  obesity?: string;
}
...
let showAnnouncementNotifications: boolean = true; // Set to true to initially show the Announcement Notifications

function toggleAnnouncementNotifications() {
  const announcementNotifications = document.querySelector<HTMLElement>(
    ".announcement-notification"
  )!;
  const notiCount = document.querySelector<HTMLElement>(".noti3")!;
  ...
  const alertsIcon = document.getElementById("alerts-icon1") as HTMLImageElement;
...
document.addEventListener("DOMContentLoaded", function () {
  const announcementContents = document.querySelectorAll<HTMLElement>(
  ...
  announcementContents.forEach((content) => {
    const icon = content.querySelector<HTMLElement>("i");
  ...
  function handleMinusIconClick(this: HTMLElement) {
  const icon = this;
  const content = icon.closest<HTMLElement>(".announcement-content");
  ...
  announcementContents.forEach((content) => {
    const icon = content.querySelector<HTMLElement>("i");
    icon?.addEventListener("click", handleMinusIconClick);
  });
...
let showAlarmNotifications: boolean = true; // Set to true to initially show the Alarm Notifications

function toggleAlarmNotifications() {
  const alarmNotifications = document.querySelector<HTMLElement>(
    ".alarm-notification"
  )!;
  const notiCount = document.querySelector<HTMLElement>(".noti")!;
  ...
  const alertsIcon = document.getElementById("alerts-icon") as HTMLImageElement;
...
document.addEventListener("DOMContentLoaded", function () {
  const alarmContents = document.querySelectorAll<HTMLElement>(".alarm-content");
  const alertsIcon = document.getElementById("alerts-icon") as HTMLImageElement;
  const notiCount = document.querySelector<HTMLElement>(".noti")!;
  ...
  function handleMinusIconClick(this: HTMLElement) {
    const icon = this;
    const content = icon.closest<HTMLElement>(".alarm-content");
